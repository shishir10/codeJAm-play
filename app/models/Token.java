...
public class Token extends Model {
     ...
     */
    private Token getNewToken(Users user, TypeToken type, String email) {
     ...
     */
    public void sendMailResetPassword(Users user, MailerClient mc) throws MalformedURLException {
     ...
     * @throws java.net.MalformedURLException if token is wrong.
     */
    public void sendMailChangeMail(Users user, @Nullable String email,MailerClient mc) throws MalformedURLException {
     ...
     * @throws java.net.MalformedURLException if token is wrong.
     */
    private void sendMail(Users user, TypeToken type, String email, MailerClient mc) throws MalformedURLException {
